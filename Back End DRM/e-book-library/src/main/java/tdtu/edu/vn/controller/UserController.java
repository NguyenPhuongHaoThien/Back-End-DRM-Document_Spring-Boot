...
import tdtu.edu.vn.repository.LoginHistoryRepository;
...
public class UserController {
    ...
    @Autowired
    public UserController(UserService userService, JwtUtilsHelper jwtUtilsHelper, ActivationCodeService activationCodeService, EmailService emailService, BCryptPasswordEncoder passwordEncoder, OTPCodeRepository otpCodeRepository, PasswordResetTokenRepository passwordResetTokenRepository, OrderService orderService, DocumentService documentService, LoginHistoryRepository loginHistoryRepository ) {
